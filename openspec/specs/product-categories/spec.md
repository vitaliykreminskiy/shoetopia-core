...
Catalog category browsing for the storefront: the public categories/navigation API, the data-access contract behind it, and the deterministic rules that categorize products at import time.
